package lesson6.year16_17.second;
/**
 * An example of a Date class with private fields, constructors and getters/setters
 * In this case we invoke setters inside constructors: more compact code and less duplications.
